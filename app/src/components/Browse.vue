    ...
    <div class="min-h-screen bg-gray-100">
      <header class="bg-white shadow sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <input
            type="text"
            @keyup.enter="(searchQuery != '') ? router.push('/search/' + searchQuery) : null"
            v-model="searchQuery"
      ...
      <div class="relative px-4 py-10 bg-gray-100">
        ...
        <p v-if="props.search!=''" class="text-lg text-gray-700 mb-6 text-center">
          Showing results for <span class="font-semibold">{{ props.search }}</span
          >.
        </p>
